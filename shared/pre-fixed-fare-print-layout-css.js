(function(global){
  ...
  function getWordPrintCss(){
    return [
      ...
      ".no-split-table { break-inside: avoid; page-break-inside: avoid; }",
      ".no-split-table table, .no-split-table tr { break-inside: avoid; page-break-inside: avoid; }",
      ".no-orphan-table { break-inside: auto; page-break-inside: auto; }",
      ".no-orphan-table table { break-inside: auto; page-break-inside: auto; }",
      ".no-orphan-table tr, .no-split-table tr { break-inside: avoid; page-break-inside: avoid; }",
      ...
      "td, th { border: 1px solid #999; padding: 2.2mm 2mm; vertical-align: middle; word-break: break-word; overflow-wrap: anywhere; white-space: normal; }",
      "td { font-size: 9pt; line-height: 1.45; }",
      "table.table-kv td:first-child, table.table-reference td:first-child, table.table-checklist td:first-child, table.table-fare-items td:first-child { text-align: center; vertical-align: middle; font-weight: 600; }",
      "table.table-kv td:nth-child(2), table.table-reference td:nth-child(2) { text-align: left; }",
      "table.table-fare-items { font-size: 9pt; }",
      "table.table-fare-items th:nth-child(1) { width: 11%; }",
      "table.table-fare-items th:nth-child(2) { width: 13%; }",
      "table.table-fare-items th:nth-child(3) { width: 11%; }",
      "table.table-fare-items th:nth-child(4) { width: 10%; }",
      "table.table-fare-items th:nth-child(5) { width: 30%; }",
      "table.table-fare-items th:nth-child(6) { width: 25%; }",
      "table.table-fare-items td:nth-child(2), table.table-fare-items td:nth-child(3), table.table-fare-items td:nth-child(4) { text-align: center; vertical-align: middle; }",
      "table.table-fare-items td:nth-child(5), table.table-fare-items td:nth-child(6) { text-align: left; vertical-align: top; }",
      "table.table-fees td:nth-child(2), table.table-reference td:nth-child(2) { text-align: center; }",
