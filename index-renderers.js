                ...
                <div style="padding:14px 0;${itemIndex < items.length - 1 ? 'border-bottom:1px solid #f3eee7;' : ''}">
                  <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;">
                    <div style="min-width:0;flex:1 1 auto;">
                      <div style="font-size:14px;font-weight:700;line-height:1.6;color:#2d2a26;">${window.IndexUtils.escapeHtml(item.name || '')}</div>
                      ${item.description ? `<div style="margin-top:4px;font-size:12px;line-height:1.7;color:#888;white-space:pre-line;word-break:break-word;">${window.IndexUtils.escapeHtml(item.description || '')}</div>` : ''}
                    </div>
                    <div style="flex:0 0 auto;font-size:14px;font-weight:700;line-height:1.6;color:#c9a96e;white-space:nowrap;padding-left:8px;">${window.IndexUtils.escapeHtml(item.price || '')}</div>
                  </div>
                </div>
