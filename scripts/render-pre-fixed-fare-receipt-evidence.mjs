...
line("TEL 090-6331-4289",font,20);
y += 8; divider();
line("領収書",font,32,"center",true);
divider();
line("発行日 2026/07/05 03:47",font,18);
line("利用日 2026/07/05 03:47",font,18);
line("案件番号 260705-MAINS-0001",font,18);
divider();
labelAmount("事前確定運賃","28,000円");
divider();
labelAmount("合計","28,000円",true);
labelAmount("支払","現金");
labelAmount("内訳 現金","28,000円");
y += 8;
line("但し書き 介護タクシー利用料として",font,20);
line("発行担当者 山本",font,20);
line("ありがとうございました",font,20,"center",true);
divider();
line("ご利用時間 1分",font,18);
line("走行距離 0.0km",font,18);
divider();
<\/script></body></html>`;
